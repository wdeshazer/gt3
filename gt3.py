...
def getVals(s, t, f):
    ...
    # data['pbeam'] = getNum("Enter beam power in MW: ", 'f')
...
def writeFile(s, t, fpath, data, reNeut=False):
    ...
    with open(fpath, "w") as f:
        ...
        f.write("ne_file         = gt3_%s_%s_ne.dat \n" % (str(s), str(t)))
        f.write("nD_file         = gt3_%s_%s_nD.dat \n" % (str(s), str(t)))
        f.write("Te_file         = gt3_%s_%s_Te.dat \n" % (str(s), str(t)))
        f.write("Ti_file         = gt3_%s_%s_Ti.dat \n" % (str(s), str(t)))
        f.write("er_file         = gt3_%s_%s_er.dat \n" % (str(s), str(t)))
        f.write("fz1_file        = gt3_%s_%s_fz1.dat \n" % (str(s), str(t)))
        f.write("fracz_file      = gt3_%s_%s_fracz.dat \n" % (str(s), str(t)))
        f.write("exlti_file      = gt3_%s_%s_exlti.dat \n" % (str(s), str(t)))
        f.write("exlte_file      = gt3_%s_%s_exlte.dat \n" % (str(s), str(t)))
        f.write("exlni_file      = gt3_%s_%s_exlni.dat \n" % (str(s), str(t)))
        f.write("vpolC_file      = gt3_%s_%s_vpolC.dat \n" % (str(s), str(t)))
        f.write("vtorC_file      = gt3_%s_%s_vtorC.dat \n" % (str(s), str(t)))
        f.write("vpolD_file      = gt3_%s_%s_vpolD.dat \n" % (str(s), str(t)))
        f.write("vtorD_file      = gt3_%s_%s_vtorD.dat \n" % (str(s), str(t)))
        f.write("q_file          = gt3_%s_%s_q.dat \n" % (str(s), str(t)))
        f.write("zbar2_file      = gt3_%s_%s_zbar2.dat    \n" % (str(s), str(t)))
        f.write("\n")
        f.write("2D QUANTITIES INPUT FILES \n")
        f.write("bpol_file       = gt3_%s_%s_bpol.dat  \n" % (str(s), str(t)))
        f.write("btor_file       = gt3_%s_%s_btor.dat  \n" % (str(s), str(t)))
        f.write("psirz_file      = gt3_%s_%s_psirz.dat \n" % (str(s), str(t)))
        f.write("\n")
        f.write("2D LINE INPUT FILES \n")
        f.write("sep_file        = gt3_%s_%s_sep.dat \n" % (str(s), str(t)))
        f.write("wall_file        = gt3_diiid_wall.dat \n")
        f.write("\n")
        ...
        f.write("neut_outfile = neutpy_cell_values.txt \n")
