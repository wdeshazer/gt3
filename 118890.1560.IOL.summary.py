...
###############################################################################
#
#    Shot 118890.1560 comparison of chis and qs w/ and w/out IOL
#
###############################################################################
...
def chiComp3(shot,shotnoIOL):
    ...
    title=r"Comparison of Ion Heat Diffusivity w/ and w/out"
...
if __name__=="__main__":
    ...
    with open("Outputs/s118890.1560.dat","wb") as f:
        pickle.dump(shot,f)
    f.close()
    ...
    with open("Outputs/s118890.1560.noIOL.dat","wb") as f:
