...
from graphs import prettyCompare
...
class s000000():
    ...
    def runid0000(self):
        ...
        prettyCompare(('rhor',self.data.rhor ),[(prettyID[0],chis[0]),(prettyID[1],chis[1]),(prettyID[2],chis[2]),(prettyID[3],chis[3])],
#                             yrange=[-4.,1.],
...
#                             marginLeft=0.075,
        ...
        prettyCompare(('rhor',self.data.rhor[:-30]),[(prettyID[0],chis[0][:-30]),(prettyID[1],chis[1][:-30]),(prettyID[2],chis[2][:-30]),(prettyID[3],chis[3][:-30])],
                             corePlot=True,
#                             yrange=[-1.,5.],
                             datalabels=[prettyID[0],prettyID[1],prettyID[2],prettyID[3]],
                             title=title,
        ...
        prettyCompare(('rhor',self.data.rhor),[(prettyID[0],qs[0]),(prettyID[1],qs[1]),(prettyID[2],qs[2]),(prettyID[3],qs[3])],
#                             yrange=[-4.E4,4.E4],
                             datalabels=[prettyID[0],prettyID[1],prettyID[2],prettyID[3]],
                             title=title,
        ...
        title=r"$\bf{Q}$ term comparison"
        adjustments={}
        prettyCompare(('rhor',self.data.rhor[:-30]),[(prettyID[0],qs[0][:-30]),(prettyID[1],qs[1][:-30]),(prettyID[2],qs[2][:-30]),(prettyID[3],qs[3][:-30])],
                             corePlot=True,
#                             yrange=[-1.E5,1.E4],
                             datalabels=[prettyID[0],prettyID[1],prettyID[2],prettyID[3]],
                             title=title,
...
class s166606():
    ...
    def runid1950(self):
        ...
        adjustments={0:.6,1:-.60,2:-1.9,3:.25}
