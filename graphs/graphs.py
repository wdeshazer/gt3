...
#   Remove the tick marks; they are unnecessary with the tick lines we just plotted.    
    ...
    #       color set in order.
        ...
        # by the viewer.
            plt.text(xrange[1]+0.0025, y_pos, column, fontsize=16, color=tableau20[rank])
...
#    plt.text((xrange[1]-xrange[0])/2.+xrange[0]+0.015, (yrange[1]-yrange[0])/20.+yrange[1], title, fontsize=26, ha="center")      
    ...
    if not legend:
        for num,label in enumerate(ylabel):
            plt.text(xrange[0]-(xrange[1]-xrange[0])/10.+yLabelAdj*(xrange[1]-xrange[0])/10.,(yrange[1]-yrange[0])/2.+yrange[0]-num*(yrange[1]-yrange[0])/10.,label,fontsize=30,ha="center")

    plt.text((xrange[1]-xrange[0])/2.+xrange[0],yrange[0]-(yrange[1]-yrange[0])/9.+xLabelAdj*(yrange[1]-yrange[0]/10.),xlabel,fontsize=16,ha="center")
