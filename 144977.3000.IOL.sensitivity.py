...
###############################################################################
#
#    Shot 144977.3000 sensitivity study of IOL and neutrals
#
###############################################################################
...
def chiComp1(shot, shotnoIOL):
    ...
    adjustments = {}
    caption = ["Ion heat conductivity in the edge for DIII-D shot 144977.3000 w/ and w/out IOL correction",
...
def chiComp2(shot, shotnoIOL):
    ...
    adjustments = {0: 1.}
    caption = ["Main ion heat conductivity in the edge for DIII-D shot 144977.3000 w/ and w/out IOL",
...
def chiComp4(shot, shotnoIOL):
    ...
    adjustments = {0: 0.}
    caption = ["Main ion heat conductivity in the edge for DIII-D shot 144977.3000 w/ and w/out IOL correction",
...
def chieComp(shot, shotnoIOL):
    ...
    adjustments = {0: 1.}
    caption = ["Main electron heat conductivity in the edge for DIII-D shot 144977.3000 w/ and w/out IOL correction",
               "neutrals calculation included"]
...
def chiComp1neuts(shot, shotnoneuts):
    ...
    adjustments = {0: -1.}
    caption = ["Ion heat conductivity in the edge for DIII-D shot 144977.3000 w/ and w/out neutrals, IOL corrected"]
...
def chiComp2neuts(shot, shotnoneuts):
    ...
    adjustments = {0: -.5}
    caption = ["Main ion heat conductivity in the edge for DIII-D shot 144977.3000 w/ and w/out neutrals",
...
def chieCompneuts(shot, shotnoneuts):
    ...
    adjustments = {0:-1.}
    caption = ["Electron heat conductivity in the edge for DIII-D shot 144977.3000 w/ and w/out neutrals",
               "IOL corrected"]
    ...
    adjustments = {}
    caption = ["Terms in electron heat conductivity in the edge for DIII-D shot 144977.3000",
...
def qComp1(shot, shotnoIOL):
    ...
    caption = ["Total heat flux for DIII-D shot 144977.3000 w/ and w/out IOL correction, neutrals calculation included"]
...
def qComp2(shot, shotnoIOL):
    ...
    caption = [
        "Convective heat flux for DIII-D shot 144977.3000 w/ and w/out IOL correction, neutrals calculation included"]
    title = r"$\bf{Q}$ term w/ and w/out IOL correction"
    adjustments = {1, -.5}
...
def qComp3(shot, shotnoIOL):
    ...
    caption = [
        "Work done by pressure for DIII-D shot 144977.3000 w/ and w/out IOL correction, neutrals calculation included"]
    title = r"$\bf{Q}$ term w/ and w/out IOL correction"
    adjustments = {}
...
def qComp4(shot, shotnoIOL):
    ...
    caption = ["Viscous heating fluxDIII-D shot 144977.3000 w/ and w/out IOL correction"]
    title = r"$\bf{Q}$ term w/ and w/out IOL correction"
    adjustments = {
    }
...
def qComp1neuts(shot, shotnoneuts):
    ...
    caption = ["Total heat flux for DIII-D shot 144977.3000 w/ and w/out neutrals"]
...
def qComp2neuts(shot, shotnoneuts):
    ...
    caption = ["Convective heat flux for DIII-D shot 144977.3000 w/ and w/out neutrals, IOL corrected"]
    title = r"$\bf{Q}$ term w/ and w/out neutrals"
    adjustments = {}
...
def qComp3neuts(shot, shotnoneuts):
    ...
    caption = ["Work done by pressure for DIII-D shot 144977.3000 w/ and w/out neutrals, IOL corrected"]
    title = r"$\bf{Q}$ term w/ and w/out neutrals"
    adjustments = {0: 0.5}
...
def qComp4(shot, shotnoneuts):
    ...
    caption = ["Viscous heat flux DIII-D shot 144977.3000 w/ and w/out neutrals, IOL corrected"]
    title = r"$\bf{Q}$ term w/ and w/out neutrals"
    adjustments = {
    }
...
def qieComp1(shot, shotnoIOL):
    ...
    caption = ["Ion-electron heat exchange for DIII-D shot 144977.3000 w/ and w/out IOL correction"]
    title = r"$\bf{Q}$ term w/ and w/out IOL correction"
    adjustments = {1, -.5}
...
def fluxComp(shot, shotnoneuts):
    ...
    caption = ["Ion radial particle flux for DIII-D shot 144977.3000 w/ and w/out neutrals"]
    ...
    caption = ["Ion radial particle flux for DIII-D shot 144977.3000 w/ and w/out IOL Correction"]
...
if __name__ == "__main__":
    ...
    try:
        shot = pickle.load(open("Outputs/s144977.3000.dat", "rb"))
    except:
        shot = GTEDGE3_cli.run(shotargs)
        with open("Outputs/s144977.3000.dat", "wb") as f:
            pickle.dump(shot, f)
        f.close()
    ...
    try:
        shotnoIOL = pickle.load(open("Outputs/s144977.3000.noIOL.dat", "rb"))
    except:
        shotnoIOL = GTEDGE3_cli.run(shotargs)
        with open("Outputs/s144977.3000.noIOL.dat", "wb") as f:
    ...
    try:
        shotnoneuts = pickle.load(open("Outputs/s144977.3000.noneuts.dat", "rb"))
    except:
        shotnoneuts = GTEDGE3_cli.run(shotargs)
        with open("Outputs/s144977.3000.noneuts.dat", "wb") as f:
