...
###############################################################################
#
#    Shot 118888.1525 comparison of chis and qs w/ and w/out IOL
#
###############################################################################
...
def chiComp2(shot,shotnoIOL):
    ...
    adjustments={0:1.}       
    caption=["Main ion heat diffusivities in the edge for DIII-D shot 118888 w/ and w/out IOL",
...
def qComp1(shot,shotnoIOL): 
    ...
    caption=["Total heat flux for DIII-D shot 118888 w/ and w/out IOL correction" ]
...
def qComp2(shot,shotnoIOL):
    ...
    caption=["Convective heat flux for DIII-D shot 118888 w/ and w/out IOL correction" ]
    title=r"$\bf{Q}$ term comparison"
    adjustments={
            }
...
def qComp3(shot,shotnoIOL):
    ...
    caption=["Work done by pressure for DIII-D shot 118888 w/ and w/out IOL correction"]
    title=r"$\bf{Q}$ term comparison"
    adjustments={
            }
...
def qComp4(shot,shotnoIOL):
    ...
    caption=["Viscous heating fluxDIII-D shot 118888 w/ and w/out IOL correction"]
    title=r"$\bf{Q}$ term comparison"
    adjustments={
            }
...
def qieComp1(shot,shotnoIOL):
    ...
    caption=["Ion-electron heat exchnage for DIII-D shot 118888 w/ and w/out IOL correction"]
    title=r"$\bf{Q}$ term comparison"
    adjustments={
            }
